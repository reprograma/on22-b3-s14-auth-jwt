...
const bcrypt = require('bcrypt') // esconde as info da senha
const jwt = require('jsonwebtoken')
const SECRET = process.env.SECRET

const create = (req,res) => {
    const senhaComHash = bcrypt.hashSync(req.body.senha, 10) // função q faz a criptografia é a hash e o 10b é a quantidade de numeros q pode ter a senha
